...
#ifdef CPU_MAP_2560_CAV // (Arduino Mega 2560) Working @EliteEng
...
// Define zero flag signal input pins and interrupt vectors.
// NOTE: All limit bit pins must be on the same port
#define ZERO_DDR       DDRC
#define ZERO_PORT      PORTC
#define ZERO_PIN       PINC
#define X_ZERO_BIT     2 // MEGA2560 Digital Pin 35
#define Y_ZERO_BIT     1 //ZERO MEGA2560 Digital Pin 36
#define Z_ZERO_BIT     0 // MEGA2560 Digital Pin 37
#define ZERO_INT       PCIE1  // Pin change interrupt enable pin
#define ZERO_INT_vect  PCINT1_vect
#define ZERO_PCMSK     PCMSK1 // Pin change interrupt register
#define ZERO_MASK ((1<<X_ZERO_BIT)|(1<<Y_ZERO_BIT)|(1<<Z_ZERO_BIT)) // All limit bits
